...
import { createFlowSchema, emitEventSchema, triggerFlowSchema, updateFlowSchema, } from "./validations/index.js";
import { eventTriggerQueue, stepQueue } from "./redis-queue.js";
import { createExecutionForFlow, getExecutionById, getExecutionHistoryForFlow, getExecutionSummary, } from "./services/execution-service.js";
import { createFlowDefinition, getFlowDefinition, listFlowDefinitions, updateFlowDefinition, } from "./services/flow-service.js";
...
router.get("/dashboard/summary", async (_req, res) => {
    try {
        ...
        const flowStatusBreakdown = flows.reduce((acc, flow) => {
